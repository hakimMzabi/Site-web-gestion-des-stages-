<?php
$page_title = "A props de nous";
include"heeader.php";
?>
<div class="col-sm-1"></div>
<div class="col-sm-9">
 <img src="pr12.jpg"style="width:1200px;height:10px00px;float:center;">
  ...
  <p> 
     <h4> The stage est une application web réalisée par l'etudiant de l'UPEC Mzabi hakim dans le cadre d'un projet .
      ...
      stages sont déposés par les entreprises et peuvent être consultés par les étudiants (de plusieurs filières). Les
