...
?>
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <textarea type="text"class="form-control my-fixed" row="8" required  id="des" name="description" value="<?php echo $row['description']; ?>" ></textarea>
                  </div>
                </div>  
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                     <input type="text"class="form-control" required  id="tit" name="titre" value="<?php echo $row['titre']; ?>">
                  </div>
                 </div>  
